...
\begin{document}
	...
	\subsection{Campo eléctrico de un objeto polarizado}
	...
	\begin{equation}
		V(\vec{r}) = \frac{1}{4\pi\epsilon_0} \oint_{\mathcal{S}} \frac{\sigma_b}{\mathfrak{r}} \, d\mathbf{s}' + \frac{1}{4\pi\epsilon_0} \int_{\mathcal{V}} \frac{\rho_b}{\mathfrak{r}} \, d\tau'
	\end{equation}
